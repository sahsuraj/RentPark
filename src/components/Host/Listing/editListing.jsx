...
class EditListing extends Component {
  ...
  getHostDetailsAPI = () => {
    api
      .postMethod("spaces_view", { host_id: this.props.match.params.id })
      .then(response => {
  ...
  handleChange = ({ currentTarget: input }) => {
    ...
    if (input.type == "checkbox") {
      ...
      formData["host_description"] = input.value;
      this.setState({ formData });
    } else {
      formData[input.name] = input.value;
      this.setState({ formData });
              ...
              <div className="col-12 col-sm-12 col-md-7 col-lg-7 col-xl-8">
                <form>
                  ...
                  <div className="host-section row">
                    ...
                    <div className="form-group col-12">
                        <h5>Parking slot dimensions (Sq.ft)</h5>
                    </div>
                  ...
                  <div className="row">
                    ...
                    >
                      {loadingContent != null ? loadingContent : "Update"}
                    </button>
