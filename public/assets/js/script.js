$(document).ready(function() {
  ...
  $(function() {
    // $(".increment-btn").append(
    //   // '<div class="inc button"><i class="fas fa-plus"></i></div>'
    // );

    // $(".decrement-btn").append(
    //   '<div class="dec button"><i class="fas fa-minus"></i></div>'
    // );
